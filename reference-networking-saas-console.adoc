...
* Do computador de um usuário ao completar seções do https://console.bluexp.netapp.com["Console baseado na Web do BlueXP "^] que está disponível como software como serviço (SaaS).
