...
| link:reference-iam-analyst-roles.html["Analista de suporte operacional"] | Fornece acesso a alertas e ferramentas de monitoramento, além da capacidade de inserir e gerenciar casos de suporte. 
