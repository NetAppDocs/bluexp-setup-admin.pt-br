...
| Backup e recuperação | Simhttps://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivityView[] a lista de destinos de backup suportados para dados de volume ONTAP ^] | Simhttps://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["Veja a lista de destinos de backup suportados para dados de volume do ONTAP"^] 
...
.6+| *Caraterísticas* | Gerenciamento de identidade e acesso do BlueXP | Sim 
...
| Não | Notificações | Sim 


| Não | Pesquisa | Sim 


| Não | Linha do tempo | Sim 
|===