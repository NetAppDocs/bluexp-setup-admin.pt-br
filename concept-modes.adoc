...
Cada modo de implantação difere em termos de requisitos de conectividade de saída, local de implantação, processo de instalação, método de autenticação, serviços de dados e armazenamento disponíveis e métodos de cobrança.

Modo padrão:: Use um serviço SaaS no console web. Dependendo dos serviços e recursos de dados que você planeja usar, um administrador do BlueXP cria um ou mais Conectores para gerenciar dados no seu ambiente de nuvem híbrida.
+
--
Este modo utiliza a transmissão de dados encriptados através da Internet pública.

--
Modo restrito:: Você instala um BlueXP Connector na nuvem (em uma região governamental, região de nuvem soberana ou região comercial) e tem conectividade de saída limitada à camada BlueXP SaaS. Os usuários acessam o BlueXP  localmente a partir do console baseado na Web que está disponível no conetor, não na camada SaaS.
+
--
...
--
Modo privado:: Você instala um BlueXP Connector no local ou na nuvem (em uma região segura, região de nuvem soberana ou região comercial) e não tem _nenhuma_ conectividade com a camada BlueXP SaaS. Os usuários acessam o BlueXP  localmente a partir do console baseado na Web que está disponível no conetor, não na camada SaaS.
+
--
