...
* Suporte para proxies transparentes para conectores dedicados ao suporte de serviços Cloud Volumes ONTAP . link:https://docs.netapp.com/us-en/bluexp/task-configuring-proxy.html["Saiba mais sobre como configurar um proxy transparente."]
...
link:https://docs.netap.com/us-en/bluexp-setup-admin/concept-federation.html["Saiba mais sobre federação de identidades no BlueXP."]
...
link:https://docs.netapp.com/us-en/bluexp/reference-iam-predefined-roles.html["Saiba mais sobre o uso de funções de acesso."]
