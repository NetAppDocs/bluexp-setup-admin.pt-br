...
[role="lead"]
O BlueXP  Identity and Access Management (IAM) é um mecanismo de controle de acesso fundamental e escalável que gerencia o acesso do usuário aos recursos do BlueXP , concedendo níveis de permissão apropriados por meio de funções de privilégio menores.

Com o IAM, você pode organizar e controlar o acesso aos recursos do NetApp. Você pode organizar seus recursos de acordo com a hierarquia da sua organização. Por exemplo, você pode organizar recursos por localização geográfica, local ou unidade de negócios. Em seguida, você pode atribuir funções do IAM a membros em partes específicas da hierarquia, o que impede o acesso a recursos em outras partes da hierarquia.
...
Os usuários devem ter a função de administrador da organização ou a função de administrador de pasta ou projeto para gerenciar pastas. Os usuários com função de administrador da organização podem criar e gerenciar recursos em qualquer lugar da sua organização BlueXP . Os usuários com função de administrador de pasta e projeto só podem fazê-lo para as pastas ou projetos aos quais foram atribuídos.

Link::reference-iam-predefined-roles.html[Saiba mais sobre as funções do BlueXP .]

Ao usar o BlueXP  IAM, os usuários com essas funções gerenciarão os seguintes componentes:
...
Uma _organização_ é o nível superior do sistema IAM da BlueXP  e normalmente representa a sua empresa. Sua organização consiste em recursos como conetores, armazenamento e assinaturas que você pode organizar em pastas e projetos. Em seguida, você pode atribuir aos membros da organização (usuário) acesso a pastas ou projetos de acordo com suas responsabilidades no gerenciamento de seus ambientes de armazenamento.
...
Dependendo do tamanho da sua organização e do número de recursos de armazenamento que você tem, as pastas são uma ferramenta útil para manter os recursos do NetApp organizados. Eles também permitem que você gerencie melhor o acesso se quiser compartilhar a administração de diferentes pastas com diferentes usuários. Você pode atribuir a um usuário a função de administrador de pasta ou projeto para uma pasta específica e, em seguida, eles podem gerenciar o acesso à pasta e seus projetos, bem como criar novos projetos na pasta.

Ao criar uma pasta, você pode atribuir aos usuários acesso a ela. Quando você atribui a um usuário uma função de acesso a uma pasta, esse usuário pode executar as tarefas associadas a essa função para todos os projetos dentro da respetiva pasta. Por outro lado, você pode optar por conceder acesso ao usuário em um projeto por projeto.
...
Você cria vários projetos para fornecer acesso mais granular aos recursos do NetApp. Por exemplo, organizações menores podem ter um projeto para cada unidade de negócios ou localização geográfica. Organizações maiores podem querer organizar seus recursos de armazenamento em vários projetos por unidade de negócios para controlar ainda mais o acesso. Você pode atribuir aos usuários acesso a recursos por projeto ou pasta.
...
Quando seus projetos residem em uma pasta, você pode
