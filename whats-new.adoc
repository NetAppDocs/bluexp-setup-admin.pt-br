...
Novos endpoints seguros para obter imagens de conetores
...
Validação do usuário para federação de identidade
...
Verificação de e-mail agora necessária
...
Solicite a atualização das credenciais NSS
...
Redução de pontos de extremidade para o conetor
...
Encriptação de disco EBS para o conetor
...
Altere as contas NSS para Cloud Volumes ONTAP
...
O conetor não é mais suportado como um proxy
...
Autenticação com o serviço principal
...
Um novo Serviço de notificação foi adicionado
...
Melhorias para o assistente Adicionar conetor
...
Gerenciamento de contas NSS do Support Dashboard
...
API chama diretamente para o Cloud Manager
...
Melhorias do Cloud Volumes ONTAP
...
Melhorias na disposição em camadas na nuvem
...
Melhorias do Azure NetApp Files
